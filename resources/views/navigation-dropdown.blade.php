            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Tableau de bord') }}
                        <span class="flex items-center justify-center w-5 h-5 text-white bg-red-500 rounded-full" id="js-count" style="margin-left: 5px;">{{ auth()->user()->unreadNotifications->count() }}</span>
                    </x-jet-nav-link>
